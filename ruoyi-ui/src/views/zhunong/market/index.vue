<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['zhunong:market:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zhunong:market:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['zhunong:market:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="marketList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="市场编号" align="center" prop="id" />
...
<script>
import { listMarket, getMarket, delMarket, addMarket, updateMarket } from "@/api/zhunong/market";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除农贸市场编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('zhunong/market/export', {
        ...this.queryParams
